  ...
  ({ size = 24, color, className, style, ...props }, ref) => {
    return (
      <svg
        ...
        {...props}
      >
        <path fill="currentColor" d="M21.965 5.143h-2.01a.43.43 0 0 0-.345.177L12 15.809 4.39 5.319a.43.43 0 0 0-.345-.176H2.036a.215.215 0 0 0-.174.34l9.445 13.02a.855.855 0 0 0 1.385 0l9.444-13.02a.213.213 0 0 0-.171-.34"/>
      </svg>
    );
  }
);
