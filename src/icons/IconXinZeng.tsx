...
/**
 * IconXinZeng icon component (multicolor)
 *
  ...
  ({ size = 24, color = 'currentColor', className, style, ...props }, ref) => {
    return (
      <svg
        ...
        {...props}
      >
        <path fill="#F5F5F5" d="M0 0h24v24H0z"/><path fill="white" d="M-288.667-236.75h793v822h-793z"/><path stroke="#0D131A" d="M12 22c5.523 0 10-4.477 10-10S17.523 2 12 2 2 6.477 2 12s4.477 10 10 10Zm0-14v8m-4-4h8"/>
      </svg>
    );
  }
);
