...
/**
 * IconSuoXiao icon component (multicolor)
 *
  ...
  ({ size = 24, color = 'currentColor', className, style, ...props }, ref) => {
    return (
      <svg
        ...
        {...props}
      >
        <path fill="#F5F5F5" d="M0 0h24v24H0z"/><path fill="white" d="M-264.666-437.5h793v822h-793z"/><path stroke="#0D131A" d="M10.5 19a8.5 8.5 0 1 0 0-17 8.5 8.5 0 0 0 0 17Zm-3-8.5h6m3.11 6.11 4.244 4.244"/>
      </svg>
    );
  }
);
