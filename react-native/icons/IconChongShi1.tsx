...
export interface IconChongShi1Props extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconChongShi1 = forwardRef<unknown, IconChongShi1Props>(
...
IconChongShi1.displayName = 'IconChongShi1'

export default IconChongShi1
