...
export interface IconFrame2Props extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconFrame2 = forwardRef<unknown, IconFrame2Props>(
...
IconFrame2.displayName = 'IconFrame2'
