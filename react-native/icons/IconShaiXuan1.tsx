...
export interface IconShaiXuan1Props extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconShaiXuan1 = forwardRef<unknown, IconShaiXuan1Props>(
...
IconShaiXuan1.displayName = 'IconShaiXuan1'
