...
export interface IconDeleteOutlineProps extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconDeleteOutline = forwardRef<unknown, IconDeleteOutlineProps>(
...
IconDeleteOutline.displayName = 'IconDeleteOutline'
