...
export interface IconShiBai1Props extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconShiBai1 = forwardRef<unknown, IconShiBai1Props>(
