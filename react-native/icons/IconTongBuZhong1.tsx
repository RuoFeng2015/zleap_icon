...
export interface IconTongBuZhong1Props extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconTongBuZhong1 = forwardRef<unknown, IconTongBuZhong1Props>(
