...
export interface IconChengYuanGuanLiProps extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconChengYuanGuanLi = forwardRef<unknown, IconChengYuanGuanLiProps>(
