...
export interface IconShanChu1Props extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconShanChu1 = forwardRef<unknown, IconShanChu1Props>(
...
IconShanChu1.displayName = 'IconShanChu1'
