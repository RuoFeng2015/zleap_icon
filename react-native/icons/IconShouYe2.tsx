...
export interface IconShouYe2Props extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconShouYe2 = forwardRef<unknown, IconShouYe2Props>(
...
IconShouYe2.displayName = 'IconShouYe2'
