...
export interface IconChengGong1Props extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconChengGong1 = forwardRef<unknown, IconChengGong1Props>(
