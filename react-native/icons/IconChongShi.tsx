...
export interface IconChongShiProps extends Omit<ComponentProps<typeof SvgXml>, 'xml' | 'width' | 'height'> {
  size?: number | string
  color?: string
}

export const IconChongShi = forwardRef<unknown, IconChongShiProps>(
...
IconChongShi.displayName = 'IconChongShi'

export default IconChongShi
